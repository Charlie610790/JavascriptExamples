...
// Engraved Pocket Knife, Personalized Groomsmen Gift, Ring Bearer Gift, Graduation Gift, 4 Knives is made of wood.
 ...
 // function to find average price
function averageprice(avprice) {
  var aryPrices = avprice.map(function(item) 
  {
    return item.price;

  })

  var sumPrices = aryPrices.reduce(function(price1, price2) 
  {
...
// averageprice(items)
//console to call information -- Isn't rounding ... and should round to $23.63
averageprice(items)

//function to look for currency code and return Title
